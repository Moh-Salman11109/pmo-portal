...
export const MOCK_PROJECTS = [
  // STRATEGY & PMO
  {
    ...
    progress: 72, plannedProgress: 68, startDate: "2025-01-15", plannedEnd: "2025-12-31", baselineEnd: "2025-12-31",
    budget: 4500000, forecast: 4350000, actualCost: 2800000,
    riskLevel: "Medium", budgetStatus: "Within Estimate", strategic: "Digital Transformation",
  ...
  },
  {
    ...
    progress: 35, plannedProgress: 45, startDate: "2025-02-01", plannedEnd: "2025-10-30", baselineEnd: "2025-10-30",
    budget: 1800000, forecast: 2100000, actualCost: 620000,
    riskLevel: "High", budgetStatus: "Over Estimate", strategic: "Corporate Strategy",
    ...
    pmoStatus: "Returned", pmoValidationNote: "Gate 2 returned by sponsor. Revise scope and cost estimates before resubmission. Risk register must be updated.", pmoValidatedBy: "", pmoValidatedDate: null,
  ...
  // DIGITAL
  {
    ...
    progress: 61, plannedProgress: 58, startDate: "2025-01-01", plannedEnd: "2025-11-30", baselineEnd: "2025-11-30",
  ...
  },
  {
    ...
    progress: 8, plannedProgress: 15, startDate: "2025-04-01", plannedEnd: "2026-03-31", baselineEnd: "2026-03-31",
    budget: 12000000, forecast: 12000000, actualCost: 320000,
    riskLevel: "High", budgetStatus: "Within Estimate", strategic: "Innovation & Technology",
  ...
  // OPERATIONS
  {
    ...
    progress: 42, plannedProgress: 58, startDate: "2024-10-01", plannedEnd: "2025-09-30", baselineEnd: "2025-09-30",
    budget: 6500000, forecast: 7200000, actualCost: 3800000,
    riskLevel: "High", budgetStatus: "Over Estimate", strategic: "Operational Excellence",
  ...
  // GRC
  {
    ...
    pm: "Abdulrahman", sponsor: "Bader",
    phase: "Execution", gate: "Gate 3", status: "On Track", priority: "Critical",
    progress: 55, plannedProgress: 52, startDate: "2025-01-01", plannedEnd: "2025-12-31", baselineEnd: "2025-12-31",
    budget: 3200000, forecast: 3100000, actualCost: 1600000,
    riskLevel: "Medium", budgetStatus: "Within Estimate", strategic: "Governance & Compliance",
  ...
  // HR
  {
    ...
    progress: 68, plannedProgress: 65, startDate: "2024-11-01", plannedEnd: "2025-08-31", baselineEnd: "2025-08-31",
    budget: 5500000, forecast: 5400000, actualCost: 3500000,
    riskLevel: "Low", budgetStatus: "Within Estimate", strategic: "People & Culture",
    lastUpdate: "2025-04-30", classification: "Operational",
  ...
  // IT
  {
    ...
    progress: 48, plannedProgress: 55, startDate: "2025-01-01", plannedEnd: "2025-12-31", baselineEnd: "2025-12-31",
    budget: 15000000, forecast: 16500000, actualCost: 7200000,
    riskLevel: "High", budgetStatus: "Over Estimate", strategic: "Digital Transformation",
    ...
    gates: [
      ...
      { id: "G2", status: "Approved",    date: "2025-02-15", approver: "Nawaf", notes: "Approved with cost caveat" },
  ...
  // FINANCE
  {
    ...
    progress: 28, plannedProgress: 25, startDate: "2025-03-01", plannedEnd: "2026-06-30", baselineEnd: "2026-06-30",
    budget: 9800000, forecast: 9800000, actualCost: 1100000,
    riskLevel: "Medium", budgetStatus: "Within Estimate", strategic: "Operational Excellence",
  ...
  // QUALITY
  {
    ...
    progress: 100, plannedProgress: 100, startDate: "2024-07-01", plannedEnd: "2025-04-30", baselineEnd: "2025-04-30",
    budget: 2200000, forecast: 2100000, actualCost: 2050000,
    riskLevel: "Low", budgetStatus: "Within Estimate", strategic: "Quality & Excellence",
  ...
  // PERFORMANCE
  {
    ...
    phase: "Execution", gate: "Gate 3", status: "On Track", priority: "High",
    progress: 58, plannedProgress: 55, startDate: "2025-02-01", plannedEnd: "2025-10-31", baselineEnd: "2025-10-31",
    budget: 3800000, forecast: 3700000, actualCost: 1900000,
    riskLevel: "Low", budgetStatus: "Within Estimate", strategic: "Performance Excellence",
...
export const MOCK_REQUESTS = [
  ...
  },
  {
    ...
    returnReason: "Cost estimate is missing. Please include a detailed cost breakdown and projected ROI before resubmission.",
    rejectionReason: "",
    linkedProjectId: "",
    approvalHistory: [
      { stage: "Project Owner / Sponsor", action: "Approved", by: "Sultan", date: "2026-05-09", notes: "" },
      { stage: "PMO Review", action: "Returned", by: "Maha", date: "2026-05-10", notes: "Cost estimate is missing. Please include a detailed cost breakdown and projected ROI before resubmission." },
    ],
  },
];
