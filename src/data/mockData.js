...
export const MOCK_REQUESTS = [
  {
    ...
    linkedProjectId: "",
    approvalHistory: [
      { stage: "Project Owner / Sponsor", action: "Approved", by: "Alhanouf Al-Salem", date: "2026-04-30", notes: "Fully support this initiative. Critical for Q3 digital strategy." },
    ],
  },
  {
    id: "RQ002", spId: 2,
    title: "Customer Portal Redesign",
    requestedBy: "Ahmed Al-Farhan",
  ...
  },
  {
    ...
    approvalHistory: [
      { stage: "Project Owner / Sponsor", action: "Approved", by: "Tariq Al-Dosari",   date: "2026-04-18", notes: "" },
      { stage: "PMO Review",              action: "Approved", by: "Maha Al-Rashid",     date: "2026-04-22", notes: "Strong business case. Fast-track." },
      { stage: "Strategy Review",         action: "Approved", by: "Bader Al-Anzi",      date: "2026-05-01", notes: "Aligned with HR digitalisation agenda." },
    ],
  },
  {
    id: "RQ004", spId: 4,
    title: "Cybersecurity Awareness Programme",
    requestedBy: "Khaled Al-Dosari",
    ...
    linkedProjectId: "",
    approvalHistory: [
      { stage: "Project Owner / Sponsor", action: "Approved", by: "Sultan Al-Ghamdi", date: "2026-05-09", notes: "" },
      { stage: "PMO Review", action: "Returned", by: "Maha Al-Rashid", date: "2026-05-10", notes: "Budget estimate is missing. Please include a detailed cost breakdown and projected ROI before resubmission." },
    ],
  },
];
...
export const MOCK_GATE_SUBMISSIONS = [
  {
    ...
    approvalHistory: [
      ...
      { stage: "PMO Review",         action: "Approved", by: "Maha Al-Rashid", date: "2026-01-23", notes: "" },
